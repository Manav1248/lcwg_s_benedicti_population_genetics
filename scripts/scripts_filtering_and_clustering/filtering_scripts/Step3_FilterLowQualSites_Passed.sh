...
echo FILTERING snps.pass.lowqualfiltered.vcf.gz FOR PASSED VARIANTS
zgrep -E '^#|PASS' snps.pass.lowqualfiltered.vcf.gz | bgzip > snps.pass.lowqualfiltered_passed.vcf.gz
echo INDEXING OUTPUT VCF
tabix snps.pass.lowqualfiltered_passed.vcf.gz

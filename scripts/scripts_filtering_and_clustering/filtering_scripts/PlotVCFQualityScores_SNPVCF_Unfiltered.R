...
#DP Zoomed In
png("SNPVCF_DP_Density_Zoomed_In.png", width=1600, height=1200)
...
#FS Zoomed In
png("SNPVCF_FS_Density_Zoomed_In.png", width=1600, height=1200)
...
#MQRankSum Zoomed In
png("SNPVCF_MQRankSum_Density_Zoomed_In.png", width=1600, height=1200)
...
#SOR Zoomed In
png("SNPVCF_SOR_Density_Zoomed_In.png", width=1600, height=1200)

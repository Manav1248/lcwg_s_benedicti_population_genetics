...
threads="28"
outdir="/scratch/bioconsult/zakas_project/PopStats_Final_Unfiltered/PopStats_pi"
...
echo GETTING Pi VALUES
pixy --stats pi --window_size ${window_size} --vcf ${path_to_vcf} --populations populations.txt --n_cores ${threads} --output_folder ${outdir}

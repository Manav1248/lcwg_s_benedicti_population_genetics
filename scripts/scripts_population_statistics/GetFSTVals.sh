...
threads="28"
outdir="/scratch/bioconsult/zakas_project/PopStats_Final_Unfiltered/PopStats_FST"
...
echo GETTING FST VALUES
pixy --stats fst --window_size ${window_size} --vcf ${path_to_vcf} --populations populations.txt --n_cores ${threads} --output_folder ${outdir}

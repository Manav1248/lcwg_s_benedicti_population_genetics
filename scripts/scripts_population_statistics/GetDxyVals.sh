...
threads="20"
outdir="/scratch/bioconsult/zakas_project/PopStats_Final_Unfiltered/PopStats_dxy"
...
echo GETTING dxy VALUES
pixy --stats dxy --window_size ${window_size} --vcf ${path_to_vcf} --populations populations.txt --n_cores ${threads} --output_folder ${outdir}
